 ...
 * This code xis an inspired modification of the union find implementation found in
 * 'Algorithm Fourth Edition' by Robert Sedgewick and Kevin Wayne.
 */
...
public class UnionFind {
    ...
    // (That method could be called 'findRoot')
