...
import com.tirkishovkadyr.datastructure.utils.TreePrinter;

/**
 * This file contains an implementation on AVL tree. An AVL tree
...
public class AVLTreeRecursive <T extends Comparable<T>> implements Iterable<T> {
    ...
    class Node implements TreePrinter.PrintableNode {
        ...
        // 'bf' is a short for Balance Factor
        int bf;
        ...
        // Node left and right children of this node
        Node left, right;
    ...
    // Returns a visual representation of the tree to the console
    public String display() {
        return TreePrinter.getTreeDisplay(root);
    }

    // Return true/false depending on whether a value exists in the node
        ...
        if (cmp < 0) {
            ...
            // the most nodes in hopes that this may help with balancing.
                ...
                if (node.left.height > node.right.height) {
                    ...
                    node.right = remove(node.left, successorValue);
                }
            }
        }
    ...
    // Helper method to find the rightmost node (which has the greatest value)
