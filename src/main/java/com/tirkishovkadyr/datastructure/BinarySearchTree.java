...
public class BinarySearchTree <T extends Comparable<T>> {
    ...
    private Node add(Node node, T elem) {
        ...
        if (node == null) {
            ...
            // Place lower elements value in left subtree
    ...
    private Node remove(Node node, T elem) {
        ...
        if (node == null) {
            ...
            // for is smaller than current value
            if (cmp < 0) {
                node.left = remove(node.left, elem);

                // Dig into right subtree, the value we're looking
                // for is greater than current value
            } else if (cmp > 0) {
                ...
                if (node.left == null) {
                    ...
                    // no subtree at all. In this situation just
                    // swap the node we wish to remove its left child.
                    ...
                    // traversing as far as possible in the right subtree.
                } else {
